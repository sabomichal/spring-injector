 ...
 * The solution is to serialize the proxy and the {@link IProxyTargetLocator} instead of the dependency,
 * and be able to look up the target object again when the proxy is deserialized and accessed. A good
 * strategy for achieving this is to have a static lookup in the {@link IProxyTargetLocator},
 * this keeps its size small and makes it safe to serialize.
 * <p>
 * Example:
 * <p>
 * <pre>
...
class LazyInitProxyFactory {
     ...
     */
    static Object createProxy(final Class<?> type, final IProxyTargetLocator locator) {
        if (PRIMITIVES.contains(type) || Enum.class.isAssignableFrom(type)) {
            return locator.locateProxyTarget();
        } else if (type.isInterface()) {
            LazyInitProxyFactory.JdkHandler handler = new LazyInitProxyFactory.JdkHandler(type, locator);
             ...
             */
            try {
                return Proxy.newProxyInstance(resolveClassLoader(), new Class[]{type, Serializable.class, ILazyInitProxy.class, LazyInitProxyFactory.IWriteReplace.class}, handler);
            } catch (IllegalArgumentException e) {
                return Proxy.newProxyInstance(LazyInitProxyFactory.class.getClassLoader(), new Class[]{type, Serializable.class, ILazyInitProxy.class, LazyInitProxyFactory.IWriteReplace.class}, handler);
            }
            ...
            callbacks[CGLIB_CALLBACK_NO_OVERRIDE] = LazyInitProxyFactory.SerializableNoOpCallback.INSTANCE;
            ...
            e.setCallbackFilter(LazyInitProxyFactory.NoOpForProtectedMethodsCGLibCallbackFilter.INSTANCE);
            e.setCallbacks(callbacks);
            e.setNamingPolicy(InjectorNamingPolicy.INSTANCE);
    ...
    static class ProxyReplacement implements Serializable {
         ...
         * @param locator
         */
        ProxyReplacement(final String type, final IProxyTargetLocator locator) {
            this.type = type;
        ...
        private Object readResolve() throws ObjectStreamException {
            ...
            try {
                ...
                ClassNotFoundException cause = new ClassNotFoundException(
                        "Could not resolve type [" + type + "] with the currently configured org.apache.wicket.application.IClassResolver");
     ...
     * @author Igor Vaynberg (ivaynberg)
     */
    public abstract static class AbstractCGLibInterceptor implements MethodInterceptor, ILazyInitProxy, Serializable, LazyInitProxyFactory.IWriteReplace {
        private static final long serialVersionUID = 1L;

        final IProxyTargetLocator locator;
         ...
         */
        AbstractCGLibInterceptor(final Class<?> type, final IProxyTargetLocator locator) {
            super();
        ...
        /**
         * @see ILazyInitProxy#getObjectLocator()
         */
        @Override
     ...
     * @author Igor Vaynberg (ivaynberg)
     */
    protected static class CGLibInterceptor extends LazyInitProxyFactory.AbstractCGLibInterceptor {
        CGLibInterceptor(Class<?> type, IProxyTargetLocator locator) {
            super(type, locator);
        }

        /**
         * @see LazyInitProxyFactory.IWriteReplace#writeReplace()
         */
        @Override
        public Object writeReplace() throws ObjectStreamException {
            return new LazyInitProxyFactory.ProxyReplacement(typeName, locator);
        }
    }
     ...
     */
    static class SerializableNoOpCallback implements NoOp, Serializable {
        private static final long serialVersionUID = 1L;

        private static final NoOp INSTANCE = new LazyInitProxyFactory.SerializableNoOpCallback();
    }
    ...
    private static class NoOpForProtectedMethodsCGLibCallbackFilter implements CallbackFilter {
        private static final CallbackFilter INSTANCE = new LazyInitProxyFactory.NoOpForProtectedMethodsCGLibCallbackFilter();
     ...
     * @author Igor Vaynberg (ivaynberg)
     */
    private static class JdkHandler implements InvocationHandler, ILazyInitProxy, Serializable, LazyInitProxyFactory.IWriteReplace {
        private static final long serialVersionUID = 1L;
         ...
         * @param locator object locator used to locate the object this proxy represents
         */
        JdkHandler(final Class<?> type, final IProxyTargetLocator locator) {
            super();
            this.locator = locator;
            typeName = type.getName();
        }
     ...
     */
    static boolean isEqualsMethod(final Method method) {
     ...
     */
    static boolean isHashCodeMethod(final Method method) {
     ...
     */
    static boolean isToStringMethod(final Method method) {
     ...
     */
    static boolean isFinalizeMethod(final Method method) {
    ...
    public static final class InjectorNamingPolicy extends DefaultNamingPolicy {
        static final LazyInitProxyFactory.InjectorNamingPolicy INSTANCE = new InjectorNamingPolicy();

        private InjectorNamingPolicy() {
            super();
        }
